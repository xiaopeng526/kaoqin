<template>
  <div class="content">
    ...
    <el-table v-loading="loading" ref="multipleTable" :data="tableData" :default-sort="{ prop: 'typeCode', order: 'ascending' }" size="small" border style="width: 100%; margin-top: -10px;" @select="handleSelectChange" @sort-change="sortChange">
      ...
      <el-table-column prop="icon" label="角色名称" sortable width="120" align="center">
        <template slot-scope="scope">
          <span v-html="formatIcon(scope.row.icon)"></span>
        </template>
      </el-table-column>
      <el-table-column prop="name" label="角色值" sortable width="300" header-align="center"></el-table-column>
      <el-table-column prop="style" label="角色权重" sortable width="200" align="center"></el-table-column>
    ...
    <!-- 编辑对话框 -->
    <el-dialog :append-to-body="true" :visible="showEditDialog" :close-on-click-modal="false" :before-close="cancleDialog" :title="isAdd ? '添加角色' : '编辑角色'" width="60%">
      <el-form ref="editForm" :model="editForm" :rules="formRules" width="80px" label-position="right" size="small">
        <el-row :gutter="24">
          ...
          <el-col :span="12">
            <el-form-item label="角色类型：" label-width="120px" prop="style">
        ...
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="角色值：" label-width="120px" prop="type">
              <el-input v-model="editForm.number" autocomplete="off" style="width:250px" @input="forceWrite($event)"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="角色权重：" label-width="120px" prop="number">
              <el-input v-model="editForm.weight" autocomplete="off" style="width:250px" @input="forceWrite($event)"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <!-- 选择角色 -->
    <el-dialog :append-to-body="true" :visible="showSelectDialog" :close-on-click-modal="false" :before-close="cancleSelect" title="选择角色" width="60%">
      <!-- 搜索开始 -->
      <el-form :model="searchIcon" :inline="true">
        <el-form-item label="角色名称：">
          <el-input v-model="selectRoleName" size="small" placeholder="请输入角色名称"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <!-- 表格 -->
      <el-table v-loading="loading" ref="multipleTable" :data="roleTableData" :default-sort="{ prop: 'typeCode', order: 'ascending' }" size="small" border style="width: 100%; margin-top: -10px;" @select="handleSelectChange" @sort-change="sortChange">
        <el-table-column type="selection" width="40" header-align="center"></el-table-column>
        <el-table-column prop="icon" label="角色名称" sortable width="200" align="center">
          <template slot-scope="scope">
            <span v-html="formatIcon(scope.row.icon)"></span>
          </template>
        </el-table-column>
        <el-table-column prop="name" label="角色值" sortable width="300" header-align="center"></el-table-column>
        <el-table-column prop="style" label="角色权重" sortable align="center"></el-table-column>
      </el-table>
      <!-- 底部 -->
      <el-row :gutter="24">
        <el-col :span="3">
